...
if (isset($_GET['sorting'])) {
    $sort = mysqli_real_escape_string($con, $_GET['sorting']);
...
$get_product = get_product($con, '', '', '', '', $sorting_order, '');
                ...
                <div class="col-lg-9 col-lg-push-3 col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div class="htc__product__rightidebar">
                        <div class="htc__grid__top">
                            ...
                            <select class="ht__select" onchange="sort_vehicle(null,'<?php echo SITE_PATH ?>')" id="sort_vehicle">
                                            ...
                                            <div class="ht__list__wrap">
                                                ...
                                                <div class="ht__list__product">
                                                    <div class="ht__list__thumb">
                                                        <a href="product-details.html"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH . $list['images']; ?>" alt="product images"></a>
                                                    </div>
